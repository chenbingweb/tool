...
Component({
  ...
  properties: {
    cityList: {
      ...
      observer: function (nVal, oldVal) {
       ...
       var newVal = this.dataChange(nVal);
        console.log(newVal)
        let noData = {
          name: '-选择-',
          code: '',
  ...
  ready: function () {
    ...
    this.selectCityObj = { code: "", name: "城市" }
  ...
  methods: {
    ...
    selectCity: function (e) {
      console.log(this.selectCityOb)
      var myEventDetail = { selectCity: this.selectCityObj, codes: this.cityListCode }  // detail对象，提供给事件监听函数
      var myEventOption = {
        bubbles: false,
        composed: false,
        capturePhase: false
